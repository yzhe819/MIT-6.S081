...
{
  // the source code is replaced by the copyin_new method in vmcopyin.c
...
{
  // the source code is replaced by the copyinstr_new method in vmcopyin.c
